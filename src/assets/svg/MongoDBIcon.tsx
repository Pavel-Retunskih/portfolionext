...
const MongoDBIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg fill="#607B96" width="24" height="24" viewBox="0 0 32 32" xmlSpace="preserve" ref={ref} {...props}>
      <path
...
const ForwardRef = forwardRef(MongoDBIcon)
