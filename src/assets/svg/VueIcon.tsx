...
const VueIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
    <svg width="24" height="24" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg"
         xmlnsXlink="http://www.w3.org/1999/xlink" {...props} ref={ref}>
      <g clipPath="url(#clip0_4815_265)">
        <path
      ...
      <defs>
        <clipPath id="clip0_4815_265">
          <rect width="24" height="24" fill="white" transform="translate(0.811523 0.42041)"/>
        </clipPath>
      </defs>
    </svg>
