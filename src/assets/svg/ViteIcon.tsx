...
const ViteIcon = (
    ...
    <svg xmlns="http://www.w3.org/2000/svg"
         ...
         width="23" height="24"
         viewBox="0 0 30 30" ref={ref} {...props}>
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <defs id="defs50">
          ...
          <linearGradient id="paint0_linear" x1="6.0002" y1="32.9999" x2="235" y2="344" gradientUnits="userSpaceOnUse"
                          gradientTransform="matrix(.07142 0 0 .07142 1.3398 1.8944)">

            <stop stopColor="#273E53" id="stop38"/>

            <stop offset="1" stopColor="#273E53" id="stop40"/>

          </linearGradient>

          <linearGradient id="paint1_linear" x1="194.651" y1="8.8182" x2="236.076" y2="292.989"
                          gradientUnits="userSpaceOnUse" gradientTransform="matrix(.07142 0 0 .07142 1.3398 1.8944)">

            <stop stopColor="#FFFFFF" id="stop43"/>

            <stop offset=".0833" stopColor="#FFFFFF" id="stop45"/>

            <stop offset="1" stopColor="#011627" id="stop47"/>
...
const ForwardRef = forwardRef(ViteIcon);
